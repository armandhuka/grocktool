...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-toolnest-bg font-inter">
      <Helmet>
        <title>About GrockTool - Your Smart Tool Directory</title>
        <meta name="description" content="Learn about GrockTool, your go-to platform for 150+ handy tools for development, productivity, and calculations - all free and accessible." />
        <link rel="canonical" href="https://grocktool.com/about" />
      </Helmet>
